...
public class StandardOutMessageRenderer implements MessageRenderer {
     ...
     * Если указать аннотацию @Autowired, то внедряемым бином может быть класс, помеченый аннотацией @Service и реализующий интерфейс MessageProvider,
     * а таких может оказаться несколько, например HelloWorldMessageProvider и Spring будет ругаться, т.к. не сможет однозначно
