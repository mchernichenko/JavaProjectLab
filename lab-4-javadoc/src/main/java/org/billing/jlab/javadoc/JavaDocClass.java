...
/** - Комментарии javadoc должны начинаться только так.

 Утилита javadoc извлекает комметрарии из следующих компонент:
 - Пакеты<br />
 - public классы и интерфейсы<br />
 - public и protected методы и поля<br />
Прим. комментарии к пакетам и обзорные комментарии см. package-info.java и overview.html
 ...
 * Первое предложение в комментарии д.б. кратким описанием, где можно использовать HTML-разметку
 ...
 <img src="../../../resources/uml.png" alt="UML диаграмма!!!" />
