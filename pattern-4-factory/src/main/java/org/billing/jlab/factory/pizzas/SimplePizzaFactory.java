 ...
 *
 * ! Методы класса-фабрики должны возвращать объекты с типом интерфейса или абстрактного класса
 * Таким образом фабрика может возвращать любую реализащию интерфейса
 *
 */
