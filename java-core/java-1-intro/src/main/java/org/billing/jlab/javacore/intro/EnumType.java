 ...
 *    - можно переопределять конструктор, что дает возможность расширять множеста без измеененич кода, расмотрено ниже
 *
...
public class EnumType {
    ...
    public static void showText(String text, Style style, EStyle eStyle, EStyle_1 eStyle_1) {
        ...
        // здесь полная нирвана, т.к. он этот код не нуждается в изменении и работает при добавлении нового стиля.
