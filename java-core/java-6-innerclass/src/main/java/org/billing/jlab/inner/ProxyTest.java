...
public class ProxyTest {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < elements.length; i++) {
            ...
            // 1. proxy-объекты реализуют все методы интерфейсов указанных в параметре-массиве. В данном случае в параметре передаём Comparable.class => в нём реализуется метод CompаreTo интерфейса Comparable.class.
